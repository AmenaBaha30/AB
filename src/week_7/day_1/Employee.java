...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        String empTwoFirstName;
        String empThreeFirstName;
        String empFourFirstName;
        String empFiveFirstName;

         empOneFirstName = "Bob";
         empTwoFirstName = "Tony";
         empThreeFirstName = "Eric";
         empFourFirstName = "Erin";
         empFiveFirstName = "John";
