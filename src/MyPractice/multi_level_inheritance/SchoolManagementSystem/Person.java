...
Steps:
    ...
    Testing:
        In the main method, create a HeadTeacher object and display all its details, including
        those from the Person and Teacher classes, and the updated subject details.
 */